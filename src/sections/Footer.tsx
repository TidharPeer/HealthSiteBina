  ...
  return (
    <footer className="bg-ink px-5 py-10 text-center text-small text-white/70">
      ...
      <div className="mx-auto mt-6 max-w-xl space-y-2 text-xs text-white/60">
        ...
        <p>
          הפרטים שנמסרים בטופס נשלחים אלי במייל באמצעות שירות הטפסים
          Web3Forms, משמשים ליצירת קשר בנוגע לתהליך בלבד ואינם מועברים או
          נמכרים לצד שלישי. אפשר לבקש את מחיקתם בכל רגע בהודעת וואטסאפ.
        </p>
      </div>
    </footer>
  )
